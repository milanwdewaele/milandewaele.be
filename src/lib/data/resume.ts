import { CodeIcon, Github, Globe, HomeIcon, NotebookIcon, Youtube, LogIn } from 'lucide-svelte';
// Navbar Icons
import GithubSvg from '$lib/imgs/github.svg';
import GithubDarkSvg from '$lib/imgs/github-dark.svg';

import MailSvg from '$lib/imgs/mail.svg';
import MailDarkSvg from '$lib/imgs/mail-dark.svg';
...
export let DATA = {
	...
	navbar: [
		...
		{ href: 'https://intern.milandewaele.be/auth', icon: LogIn, label: 'Intern' }
	],
	contact: {
	...
	work: [
		{
			...
			badges: [],
			location: 'Remote',
			title: 'Head of Development & Founder',
			logoUrl: Harmony,
			start: 'January 2021',
			end: 'August 2023',
	...
	education: [
		{
			school: 'VHSI',
			href: 'https://vhsi.be',
			degree: ' Office administration and data management',
			logoUrl: VHSI,
			start: '2020',
			end: '2025'
		}
	...
	projects: [
		{
			title: 'Harmony: Version 3',
			href: '/',
			dates: 'November 2022 - October 2023',
			active: false,
			description: 'Work-in-progress radio platform. Cancelled due to termination of the brand.',
			technologies: ['CSS', 'TailwindCSS', 'MongoDB', 'ExpressJS', 'NodeJS'],
			links: [],
			image: '',
			video:
		...
		},
		{
			...
			href: 'https://weareharmony.net/app/',
			dates: 'November 2022 - October 2023',
			active: false,
			description: 'Radio player with profiles, shop, news and more.',
			technologies: ['CSS', 'TailwindCSS', 'MongoDB', 'ExpressJS', 'NodeJS'],
			links: [
				{
					type: 'Website',
			...
			image: 'https://mdwnetcdn.s3.us-east-1.amazonaws.com/image-2.webp',
			video: ''
		},
		{
			title: 'PostIt',
			href: 'https://postit.playground.milandewaele.be/',
			dates: 'November 2022 - October 2023',
			active: true,
			description:
				"Social media concept based on Instagram's infinite scrolling feed. Supported text, images and video's.",
			technologies: ['CSS', 'MongoDB', 'ExpressJS', 'NodeJS'],
			links: [
				{
					type: 'Webapp',
					href: 'https://postit.playground.milandewaele.be/',
				...
				{
					type: 'Source',
					href: 'https://github.com/milanwdewaele/PostIt',
					icon: Github
					// icon: <Icons.github className="size-3" />,
				}
			],
			image:
				'https://pouch.jumpshare.com/preview/XEb6ouvnIub7tbV89fPXJSxgsI9rQip4Mb-9eOHd3BL9L45O3q-jp1HleFgOp5keXL5_tgHUf8BHnAB5AS_AKUa-8bhouBbUfXp03Vr459s',
			video: ''
		},
		{
			title: 'Gent is Art',
			href: 'https://gentiskunst.playground.milandewaele.be/',
			...
			links: [
				...
				{
					type: 'Source',
					href: 'https://github.com/milanwdewaele/gentiskunst',
					icon: Github
					// icon: <Icons.github className="size-3" />,
				}
			],
